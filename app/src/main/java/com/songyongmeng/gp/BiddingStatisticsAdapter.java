...
public class BiddingStatisticsAdapter extends RecyclerView.Adapter<BiddingStatisticsAdapter.MyViewHolder> {
    private List<BiddingStatisticsBean> mDataList;
    private List<BiddingStatisticsBean> originalFenQiList;
    Comparator<BiddingStatisticsBean> comparator;

    private OnBiddingItemClickListener mListener;
    ...
    public BiddingStatisticsAdapter(Context context, List<BiddingStatisticsBean> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new BiddingStatisticsAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, int position) {
        BiddingStatisticsBean data = mDataList.get(position);
...
//        Comparator<BiddingStatisticsBean> comparator = new Comparator<BiddingStatisticsBean>() {
//            @Override
//            public int compare(BiddingStatisticsBean bean1, BiddingStatisticsBean bean2) {
//                if (isLastHasBuy) {
...
//    }
    ...
    public void changeDescription() {
        comparator = new Comparator<BiddingStatisticsBean>() {
            ...
            public int compare(BiddingStatisticsBean bean1, BiddingStatisticsBean bean2) {
                if (description) {
                    return bean2.getDescription().compareTo(bean1.getDescription());
                } else {
                    return bean1.getDescription().compareTo(bean2.getDescription());
                }
            }
        };
        Collections.sort(mDataList, comparator);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(BiddingStatisticsBean data) {
            // 清空容器中的所有子视图
